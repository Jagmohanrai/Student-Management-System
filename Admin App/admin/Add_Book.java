...
public class Add_Book extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1);
        jLabel1.setBounds(210, 60, 118, 43);

        jLabel2.setFont(new java.awt.Font("Times New Roman", 0, 36)); // NOI18N
        jLabel2.setText("ISBN");
        jPanel1.add(jLabel2);
        jLabel2.setBounds(210, 10, 90, 35);

        jLabel3.setFont(new java.awt.Font("Times New Roman", 0, 36)); // NOI18N
        jLabel3.setText("writer");
        jPanel1.add(jLabel3);
        jLabel3.setBounds(210, 110, 149, 43);

        jLabel4.setFont(new java.awt.Font("Times New Roman", 0, 36)); // NOI18N
        jLabel4.setText("code");
        jPanel1.add(jLabel4);
        jLabel4.setBounds(230, 160, 98, 38);

        jname.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jPanel1.add(jname);
        jname.setBounds(330, 60, 180, 43);
        ...
        jwiriter.setBounds(330, 110, 180, 43);

        jcode.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jPanel1.add(jcode);
        jcode.setBounds(330, 160, 180, 46);
        ...
        jButton1.setBounds(300, 210, 210, 50);

        jButton2.setBackground(new java.awt.Color(255, 255, 255));
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/NEW BACK  .png"))); // NOI18N
        ...
        jButton2.setBounds(10, 270, 40, 40);
        ...
        jButton3.setBounds(270, 270, 240, 40);

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/add book_1.png"))); // NOI18N
        jPanel1.add(jLabel5);
