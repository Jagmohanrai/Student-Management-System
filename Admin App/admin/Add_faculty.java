...
public class Add_faculty extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton2.setBounds(10, 370, 40, 40);

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/ADD FACULTY.png"))); // NOI18N
        jPanel1.add(jLabel4);
...
//            conn= DriverManager.getConnection(url,user,pass);
            ...
            if (n>0)
            {
                JOptionPane.showMessageDialog(rootPane, "REGISTRATION IS SUCCESFULL");
