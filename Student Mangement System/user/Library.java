...
public class Library extends javax.swing.JFrame {
    ...
    public Library(String temp)
    {
       ...
       while (rs.next())
       {
            ...
            jname.setText(s);
            book1=(rs.getString(13));
            book2=(rs.getString(14));
    ...
    private void initComponents() {
        ...
        jButton1.setBounds(710, 10, 40, 30);
        ...
        jbook2.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        jbook2.setForeground(new java.awt.Color(0, 51, 51));
        jbook2.setText("book2");
        jPanel1.add(jbook2);
        jbook2.setBounds(10, 500, 190, 38);

        jbook1.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        jbook1.setForeground(new java.awt.Color(0, 51, 51));
        jbook1.setText("book1");
        jPanel1.add(jbook1);
        jbook1.setBounds(10, 360, 190, 34);

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/project images/LIBRARY STUDENT.png"))); // NOI18N
        jPanel1.add(jLabel1);
